...
j=0
names.sort()
filenames = os.listdir("./output") #where the images are stores
filenames.sort()
for filename in filenames:
  if i < 8000:
    shutil.copy("./output/"+filename,"./images/train/"+names[j]+"/")
    i+=1
  elif i<10000:
    shutil.copy("./output/"+filename,"./images/test/"+names[j]+"/")
    i+=1
  else:
    j+=1
    i=0
